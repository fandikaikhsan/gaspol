...
const journeySteps: JourneyStep[] = [
  {
    title: "1. Baseline",
    description:
      "Cek level awalmu lewat diagnostic singkat berbasis tipe soal UTBK.",
    badge: "Diagnosa awal",
    Icon: Target,
  ...
  },
  {
    title: "2. Plan",
    description:
      "Dapat rencana belajar adaptif harian sesuai target kampus dan jurusan.",
  ...
  },
  {
    title: "4. Analytics",
    description:
      "Pantau progres, akurasi, dan kesiapanmu menjelang hari H UTBK.",
...
const testimonials = [
  {
    ...
    quote:
      "Sebelumnya aku bingung harus mulai dari mana. Setelah pakai Gaspol, aku tinggal ikutin plan harian dan progresku kerasa naik.",
    avatar:
  ...
  },
  {
    ...
    quote:
      "Yang paling ngebantu itu latihan fokus di bagian yang paling lemah. Waktu belajarku jadi lebih efektif menjelang UTBK.",
    avatar:
  ...
  },
  {
    ...
    quote:
      "Aku suka karena tampilannya jelas. Orang tuaku juga jadi lebih tenang karena bisa lihat progresku dari minggu ke minggu.",
    avatar:
...
const pricingPlans = [
  {
    name: "Starter",
    subtitle: "Untuk mulai terarah",
    price: "Rp79.000",
    period: "/bulan",
    audience: "Cocok untuk siswa yang baru mulai persiapan serius.",
    cta: "Pilih Starter",
    href: "/signup",
    featured: false,
    Icon: ShieldCheck,
    features: [
      "Baseline diagnostic + analisis area lemah",
      "Rencana belajar mingguan adaptif",
      "Akses latihan terarah (core set)",
      "Ringkasan progres dasar",
      "Support via email",
    ],
  },
  {
    ...
    price: "Rp149.000",
    period: "/bulan",
    audience: "Untuk sprint UTBK dan target peningkatan lebih agresif.",
    cta: "Pilih Intensive",
    href: "/signup",
    featured: true,
    Icon: Zap,
    features: [
      "Semua fitur Starter",
      "Drill adaptif lebih dalam + prioritas topik",
      "Analitik progres lengkap & rekomendasi aksi",
      "Checkpoint kesiapan menjelang hari H",
      "Prioritas support",
    ],
  },
]
...
export default function LandingPage() {
  return (
    <main className="min-h-screen bg-background text-foreground">
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-6 py-16 sm:py-20 lg:grid-cols-2 lg:gap-12 lg:py-24">
          <div className="text-center lg:text-left">
            ...
            <h1 className="mb-4 text-balance text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
              Belajar lebih terarah untuk UTBK — tenang untuk siswa, lega untuk
              orang tua
            </h1>
            <p className="mb-8 max-w-2xl text-pretty text-base text-muted-foreground sm:text-lg lg:mx-0 mx-auto">
              Gaspol bantu siswa fokus ke materi prioritas, latihan adaptif, dan
              progres yang terukur. Cocok untuk persiapan intensif menjelang
              UTBK-SNBT.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 text-sm text-muted-foreground lg:justify-start">
              ...
              <Badge variant="outline" className="font-normal">
                Fokus UTBK-SNBT 2026
              </Badge>
              <Badge variant="outline" className="font-normal">
                Belajar terarah + terukur
              </Badge>
            </div>
          </div>
      ...
      <section className="relative mx-auto w-full max-w-6xl px-6 py-14 sm:py-16">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Langkah yang jelas biar progres lebih cepat terlihat.
            </p>
          </div>
          <Badge variant="outline" className="gap-1">
            <Sparkles className="h-3.5 w-3.5" aria-hidden="true" />4 langkah
            jelas
          </Badge>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {journeySteps.map((step) => (
            ...
            >
              <div
                className={`absolute inset-x-0 top-0 h-16 bg-gradient-to-b ${step.glowClassName}`}
              />
          ...
          <div className="mt-8">
            <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  Cerita dari siswa yang belajar pakai Gaspol.
                </p>
              </div>
              <Badge variant="outline" className="gap-1">
              ...
              {testimonials.map((testimonial) => (
                ...
                >
                  <CardContent className="pt-6">
                    <Quote
                      className="mb-3 h-5 w-5 text-primary/70"
                      aria-hidden="true"
                    />
        ...
        <div className="relative pl-5">
          ...
          <div className="space-y-6">
            {keyDates.map((entry) => (
              <div
                key={entry.item}
                className="relative rounded-lg border border-border/70 bg-card p-4 shadow-sm"
              >
                <span
                  className={`absolute -left-5 top-5 h-3 w-3 rounded-full border-2 border-background ${entry.dotClassName}`}
                />
                <div className="mb-2 flex items-center gap-2">
                  <entry.Icon
                    className={`h-4 w-4 ${entry.iconClassName}`}
                    aria-hidden="true"
                  />
      ...
      <section
        id="pricing"
        className="mx-auto w-full max-w-6xl px-6 py-14 sm:py-16 border-t bg-muted/20"
      >
        <div className="mb-6 text-center">
          ...
          <h2 className="text-3xl font-semibold tracking-tight">
            Pilih paket belajar sesuai ritme kamu
          </h2>
          <p className="mx-auto mt-2 max-w-2xl text-sm text-muted-foreground">
            Dirancang untuk pasar persiapan UTBK: terjangkau untuk keluarga,
            tapi tetap fokus pada outcome belajar yang nyata dan terukur.
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {pricingPlans.map((plan) => (
            <Card
              key={plan.name}
              className={`relative h-full border-border/70 ${plan.featured ? "ring-2 ring-primary/30 shadow-lg" : "shadow-sm"}`}
            >
              {plan.featured && (
        ...
        <div className="mt-5 rounded-lg border bg-muted/40 p-4 text-center text-xs text-muted-foreground">
          Harga dapat disesuaikan saat promo/event tertentu. Tidak ada klaim
          jaminan kelulusan—fokus kami adalah kualitas latihan, struktur
          belajar, dan peningkatan performa yang terukur.
        </div>
      </section>
      ...
      <section className="border-t">
        <div className="mx-auto flex max-w-6xl flex-col items-center px-6 py-16 text-center">
          ...
          <p className="mb-8 max-w-2xl text-muted-foreground">
            Buat akun, kerjakan baseline, dan langsung dapat roadmap belajar
            yang bisa dieksekusi hari ini.
          </p>
          ...
          <p className="text-xs text-muted-foreground">
            Mulai dalam hitungan menit • Tanpa setup rumit
          </p>
        </div>
      </section>
    </main>
